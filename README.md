...
We decided to choose the smallest value of both extremities to Grid2op from pypowsybl. We also chose to take into account
only permanent limit in current.
